      ...
      <div className="text-backing2 about-me-padding text-1">
        ...
        <div className="card-width2">
          ...
          <p>
            ...
            was a no-brainer for me. I previously did art, photography, maths
            and biology as A-level subjects at a performing arts sixth-form
            college and went on to do a foundation year in art and photography,
            before pursuing healthcare. Software engineering, for me, has
            re-ignited my creativity. It also challenges me mentally on a daily
            basis which is all could ask for from a life-long career.
          </p>
          <p>
          ...
          <h3>List of impulsive and less-impulsive achievements (in no particular order):</h3>
          <ul>
            <li>
